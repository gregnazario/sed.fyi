  ...
  return (
    ...
    >
      ...
      <div className="p-5">
        ...
        {/* Tech Stack */}
        <ul className="flex flex-wrap gap-1.5 mb-5 list-none" aria-label="Technologies used">
        ...
        <div className="flex items-center gap-2">
          ...
          {project.githubUrl && (
            <a
              ...
              className="inline-flex items-center gap-1.5 px-3 py-2 text-sm font-medium text-zinc-400 border border-white/[0.08] rounded-lg hover:text-zinc-200 hover:border-white/20 hover:bg-white/[0.04] transition-all"
